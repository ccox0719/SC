...
// Back-compat alias if other spots call it:
...
/* ================= Rendering ================= */
function setHint(t){ const el=$("actionHint"); if(el) el.textContent=t; }
function setSelected(t){ const el=$("selectedInfo"); if(el) el.textContent=t||"—"; }
